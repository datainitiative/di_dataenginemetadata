...
# --------------------
## Settings attributes
from dataenginemetadata.settings import SERVER_URL,ROOT_URL,APP_SERVER_URL
...
# Investment CSV file path
## use this for [LOCALHOST] -> ******************************************!!!->
#Investment_IMPORT_PATH = 'C:/QLiu/ql_dj/apps/Data-Commons-MetaData-App/data/import_InvestmentsAugust2014YTD.csv'
## <- use this for [LOCALHOST]

## use this for [SERVER] ->
Investment_IMPORT_PATH = '\\\\pitondc1\\Departments\\Data\\DataCommons\\DCApplication\\Data-Commons-MetaData-App\\data\\import_InvestmentsAugust2014YTD.csv'
## <- use this for [SERVER] ********************************************<-!!!
...
## use this for [SERVER] ->
SERVER_APP_ROOT = "/demetadata"
## <- use this for [SERVER] ********************************************<-!!!

# Admin email
ADMIN_EMAIL_ADDRESS = "dataenginemetadata@gmail.com"
## use this for [LOCALHOST] and Debugging -> ******************************************!!!->
TO_EMAIL_ADDRESS = ["liu.qing.1984@gmail.com"]
TO_DE_ADMIN_EMAIL_ADDRESS = ["liu.qing.1984@gmail.com"]
## <- use this for [LOCALHOST] and Debugging
## use this for [SERVER] ->
#TO_EMAIL_ADDRESS = ["dataenginemetadata+admin@gmail.com","mzhang@garycommunity.org"]
#TO_DE_ADMIN_EMAIL_ADDRESS = ["dataenginemetadata+admin@gmail.com","jnewcomer@garycommunity.org","mzhang@garycommunity.org"]
## <- use this for SERVER ***********************************************<-!!!
